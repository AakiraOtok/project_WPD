...
from utils.box_utils import Non_Maximum_Suppression, coco_style, draw_bounding_box
...
if __name__ == "__main__":
    ...
    with open(result_file, 'w') as f:
        ...
        for img_dict in tqdm(images_dict):
            ...
            pred_bboxes, pred_labels, pred_confs = Non_Maximum_Suppression(dboxes, offset[0], conf[0], conf_threshold=0.01, iou_threshold=0.45, top_k=100, num_classes=num_classes)
